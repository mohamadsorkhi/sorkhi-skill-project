...
class UpdateProjectRequest extends FormRequest
{
    public function authorize(): bool
    {
        ...
        return Auth::check() && $project && $project->employer_id === Auth::id();
    }
    ...
    protected function failedAuthorization()
    {
        if (request()->expectsJson()) {
            abort(response()->json(['message' => 'شما اجازه ویرایش این پروژه را ندارید.'], 403));
        }
        abort(403, 'شما اجازه ویرایش این پروژه را ندارید.');
    }
